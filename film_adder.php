<html>
  ...
  <body>
    ...
    <span id="success">
      The movie was successfully added to Tvinder! <br>
      If you want to add another movie < <a href="film_form.php">Click here</a> >
    </span>
  </body>
</html>
<?php
...
$query = "INSERT INTO films (film_name, film_poster, film_release, film_type) VALUES (\"".$film_name."\",\"".$target_file."\",\"".$film_release."\", \"film\");";
//connect to database
$user = "root";
$password = "";
$db = "tvinder";
